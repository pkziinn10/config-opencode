...
Write to `SPEC.md`. Show user full file. Use `question` tool: "Spec OK? (a) looks good — invoke `/build` (b) high-blast-radius — invoke `/review` first (c) suggest edits"
...
Steps:
1. Load `backprop` skill and parse bug description.
